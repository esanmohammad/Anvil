 ...
 *
 * Phase F10 — promoted from `packages/dashboard/server/plan-risk-scorer.ts`
 * into `core-pipeline/utils`. Depends on F7's `Plan` and F9's risk
 * vocabulary, both already in this package.
 *
