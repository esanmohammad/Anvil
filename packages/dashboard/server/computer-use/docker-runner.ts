 ...
 */
export async function createDockerComputerRunner(opts: ComputerRunnerOpts): Promise<ComputerRunner> {
  void opts;
  throw new Error(
    'Tier 3 pixel-browser requires Docker. Install Docker, then enable via ' +
 ...
 */
export function createMockComputerRunner(): ComputerRunner {
