...
export interface DashboardStores {
  ...
  // Plan / test / review / incident domain stores
...
export function createDashboardStores(deps: StoresBundleDeps): DashboardStores {
  ...
  const costLedger: CostLedger = new BridgedCostLedger(deps.anvilHome);
