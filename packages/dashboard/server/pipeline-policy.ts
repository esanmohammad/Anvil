...
/**
 * Built-in default policy used when no `pipeline-policy.yaml` exists. The
 * dashboard ships with this on by default so first-time users see the review
 * pause after Plan without having to author a yaml.
 */
