...
export async function loadPrDiff(repo: string, prNumber: number): Promise<{
  diff: string;
...
export function normaliseFinding(partial: Partial<ReviewFinding> & {
...
export function severityToAnnotation(
  s: Severity,
