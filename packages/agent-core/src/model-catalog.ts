 ...
 *
 * Promoted to `@esankhan3/anvil-agent-core` in Phase F1 of the dashboard
 * pipeline-runner deprecation plan (`docs/dashboard-pipeline-deprecation-plan.md`).
 * Lives next to the provider adapters because token limits are
 * provider-shaped knowledge — same layer as which envelope each provider
 * accepts. Cli + dashboard + future tooling all read from here.
 *
